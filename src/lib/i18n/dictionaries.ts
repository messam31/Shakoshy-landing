const en = {
	...
	hero: {
		...
		points: [
			...
			{
				text: "Track your job and chat with workers, ",
				highlight: "all in one app",
			},
			{
				text: "Get real offers from nearby professionals ",
...
const ar: Dictionary = {
	...
	hero: {
		...
		points: [
			...
			{ text: "تابع مهمتك وتحدّث مع العمال ", highlight: "في تطبيق واحد" },
			{
				text: "احصل على عروض حقيقية من محترفين قريبين ",
				highlight: "خلال دقائق",
			},
		],
